...
class UserPreferencesControllerTest < ActionController::TestCase
  ...
  test "should update user_preference" do
    put :update, id: @user_preference, user_preference: { active: @user_preference.active, custom_id: @user_preference.custom_id, language: @user_preference.language, user_id: @user_preference.user_id }
    assert_redirected_to user_preference_path(assigns(:user_preference))
  end
